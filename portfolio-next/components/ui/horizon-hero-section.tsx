    ...
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div className="hero-content cosmos-content">
        <h1 ref={titleRef} className="hero-title">
          YEDRU NAGA<br />
          <span style={{ color: '#00f5a0' }}>PRAGNESH</span>
        </h1>
        
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line">
            Computer Science Undergraduate | SRM University AP
          </p>
          <p className="subtitle-line">
            Building with Data, Code & Generative AI
          </p>
        </div>
        ...
        <div style={{ 
          ...
          <a href="#projects" style={{
            ...
            e.currentTarget.style.backgroundColor = '#00c9ff';
            e.currentTarget.style.transform = 'scale(1.05)';
          }} onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = '#00f5a0';
      ...
      <div className="scroll-sections">
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles: Record<number, { line1: string; line2: string; }> = {
            ...
            1: {
              line1: 'From SRM University AP',
              line2: 'Exploring the intersection of data science and technology'
            },
            2: {
              line1: 'Computer Science Undergraduate',
              line2: 'Available for internships & collaborations in 2026'
            }
          };
